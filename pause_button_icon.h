...
void set_button_in_stopping_menu(){
     ...
     heart_icon_in_pause_interface.loadtexture("heart_icon.bmp");
...
void set_icon_pause_button_active(int x_mouse,int y_mouse,int &click,SDL_Event _e,bool &stopping_time,
     ...
     if(x_mouse>=pause_button.gettdx() && x_mouse<= pause_button.gettdx()+image_pause.getwidth()&&
        ...
        if(_e.type==SDL_MOUSEBUTTONUP){
          ...
          saving_time_effect_of_skill3_of_AI[0]=SDL_GetTicks()-time_appearing_of_effect_of_skill3_from_AI[0];
          saving_time_effect_of_skill3_of_AI[1]=SDL_GetTicks()-time_appearing_of_effect_of_skill3_from_AI[1];
          saving_time_skill3_of_AI_active=SDL_GetTicks()-time_in_game;
