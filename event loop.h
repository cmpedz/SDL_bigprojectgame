     ...
     cout<<"failed to load SDL"<<endl;
      ...
      if(tdx_character2-tdx_character1<=30 && tdx_character2-tdx_character1>=-30 && tdy_character2 == tdy_character1){
        ...
        if(does_skill1_of_character1_active){
           set_skill1_of_character1_active(tdy_character2,tdx_beam,tdx_skill1_of_character1,tdy_skill1_of_character1,height_of_beam,width_of_beam,tdy_beam,time_watting_for_skill1_of_character1);
...
//*************************************************************//
         ...
         // set skill2_of_AI_actived
          ...
          set_skill3_of_character2_active(time_in_game);
