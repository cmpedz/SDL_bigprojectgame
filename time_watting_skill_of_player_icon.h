...
void set_icon_skill_of_player(){
     icon_skill1_of_player.loadtexture("skill1_watting_sign.bmp");
     ...
     icon_time_watting_skill1.loadtexture("it_is_just_white.bmp");
     ...
     icon_skill2_of_player.loadtexture("skill2_watting_sign.bmp");
     ...
     icon_time_watting_skill2.loadtexture("it_is_just_white.bmp");
     ...
     icon_skill3_of_player.loadtexture("skill3_watting_sign.bmp");
     ...
     icon_time_watting_skill3.loadtexture("it_is_just_white.bmp");
     ...
     icon_skill2_of_AI.loadtexture("icon_skill2_of_AI.bmp");
     ...
     icon_time_watting_skill2_of_AI.loadtexture("it_is_just_white.bmp");
