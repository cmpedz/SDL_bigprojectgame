...
void set_chr1_jump(bool &_can_character1_jump,int &_tdy_character1,const int _tdy_of_ground,
                   double _set_time_in_the_air_of_character1,double _v_of_character1){

     if(_can_character1_jump){
              _tdy_character1=_tdy_character1-set_gravity(_v_of_character1,_set_time_in_the_air_of_character1);
